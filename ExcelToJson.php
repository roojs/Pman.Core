...
class Pman_Core_ExcelToJson extends Pman_Roo
{
    ...
    function importCsv($csv)
    {
        ...
        foreach ($rows['TRANSFER ITEMS'] as $r){
            ...
            $itemsite->autoJoin();
            $itemsite->whereAdd("join_itemsite_item_id_item_id.item_number = {$this->escape($r['ITEM CODE'])}");
            $itemsite->find(true);
            print_r($itemsite);exit;
//            if(!$itemsite->get('join_itemsite_item_id_item_id.item_number', )){
...
//            }
            ...
            $ret[] = array(
                ...
                'itemsite_item_id_item_number' => $r['itemsite_item_id_item_number']
            );
        }
