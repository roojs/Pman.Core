...
Pman.Tab.CoreMailingListMessage = new Roo.XComponent({
    part     :  ["Core","MailingListMessage"],
    order    : '999-Pman.Tab.CoreMailingListMessage',
    region   : 'center',
                ...
                items : [
                    {
                        ...
                        grid : {
                            ...
                            listeners : {
                                ...
                                {
                                    _this.grid = this; 
                                    _this.dialog = Pman.Dialog.CrmMailingListMessage;
