...
ALTER TABLE Events ALTER COLUMN EventID id INT(11) AUTO_INCREMENT NOT NULL;
ALTER TABLE Events ALTER COLUMN User person_name VARCHAR(128);
ALTER TABLE Events ADD COLUMN person_id INT(11);
ALTER TABLE Events ALTER COLUMN Date event_when DATETIME;
ALTER TABLE Events ALTER COLUMN Event action VARCHAR(32);
ALTER TABLE Events ALTER COLUMN Host ipaddr VARCHAR(16);
ALTER TABLE Events ALTER COLUMN ItemID on_id INT(11);
ALTER TABLE Events ALTER COLUMN Container on_table VARCHAR(64);
