    ...
    {   
        ...
        if (!empty($this->preheader)) {
            ...
            if ($body) {
                ...
                // pad is spliced after saveHTML — libxml drops UTF-8 nbsp/zwnj from text nodes
