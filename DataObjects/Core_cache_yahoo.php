...
class Pman_Core_DataObjects_Core_Cache_Yahoo extends DB_DataObject 
{
    ...
    */
    function checkYahoo($str, $userAgent) 
    {
        ...
        // $userAgent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) SEOAnalyzerBot/1.0 Chrome/125.0.6422.21 Safari/537.36"; // OK
        ...
        // $userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Edge/124.0.2478.67 Safari/537.36"; // OK
        // $userAgent = "Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko"; // OK
        $header = array(
            // this results in 429 for some reason
            "User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.6723.116 Safari/537.36"
