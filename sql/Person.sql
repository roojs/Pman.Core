...
ALTER TABLE Person DROP COLUMN addr_state;

ALTER TABLE Person ADD COLUMN country_id INT(11) NOT NULL DEFAULT 0;
ALTER TABLE Person ADD COLUMN city_id INT(11) NOT NULL DEFAULT 0;
ALTER TABLE Person ADD COLUMN division INT(11) NOT NULL DEFAULT 0;
