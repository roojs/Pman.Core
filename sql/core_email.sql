...
ALTER TABLE core_email MODIFY COLUMN bcc_group INT(11) NOT NULL DEFAULT 0;
...
ALTER TABLE coba_person_investor_profile CHANGE COLUMN  in_group to_group INT(11) NOT NULL DEFAULT -1;
ALTER TABLE core_email ADD COLUMN in_group INT(11) NOT NULL DEFAULT -1;
