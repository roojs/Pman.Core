 ...
 * 
 * Usage:
 *   php press.php Core/Process/CreateDeleteTriggers                    # Create triggers for all tables
 *   php press.php Core/Process/CreateDeleteTriggers -t table_name      # Create trigger for specific table only
 * 
 * @author System
 */
...
class Pman_Core_Process_CreateDeleteTriggers extends Pman_Core_Cli
{
